...
CFLAGS += -fno-ident -DHAVE_COMPRESSION -DARCHIVE_USE_BUILTIN_DEFLATE -DHAVE_RCHD_DEFLATE -DHAVE_RCHD_LZMA -DHAVE_RCHD_FLAC -DHAVE_RCHD_ZSTD -DUSE_LIBRETRO_VFS
CXXFLAGS += -std=c++14 -fno-exceptions -fno-rtti -fno-ident -DHAVE_COMPRESSION -DARCHIVE_USE_BUILTIN_DEFLATE -DHAVE_RCHD_DEFLATE -DHAVE_RCHD_LZMA -DHAVE_RCHD_FLAC -DHAVE_RCHD_ZSTD -DUSE_LIBRETRO_VFS
